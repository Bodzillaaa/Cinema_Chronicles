          ...
          <Table.Root p={4} variant={"outline"} mt={4} borderWidth="1px">
            <Table.Header>
              <Table.Row>
                ...
                <Table.ColumnHeader>Box Office</Table.ColumnHeader>
                ...
                <Table.ColumnHeader>Release Year</Table.ColumnHeader>
                <Table.ColumnHeader>Language</Table.ColumnHeader>
                <Table.ColumnHeader>Duration</Table.ColumnHeader>
                <Table.ColumnHeader>Poster</Table.ColumnHeader>
                <Table.ColumnHeader>Update Info</Table.ColumnHeader>
                <Table.ColumnHeader>Delete Movie</Table.ColumnHeader>
              </Table.Row>
            </Table.Header>
            <Table.Body>
              {movies.map((movie) => (
                  ...
                  {editingMovie === movie.movie_id ? (
                    <>
                      ...
                      <Table.Cell>
                        <Button
                          bg={"cyan.500"}
                          onClick={() => updateMovie(movie.movie_id)}
                        >
                          Save
                        </Button>
                      </Table.Cell>
